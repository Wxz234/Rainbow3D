...
namespace Rainbow3D {
	...
	public:
		dx11RenderTarget(ID3D11Resource* texture2D, ID3D11ShaderResourceView* srv = nullptr, ID3D11RenderTargetView* rtv = nullptr, ID3D11UnorderedAccessView* uav = nullptr) {
			m_texture = texture2D;
			m_srv = srv;
			m_rtv = rtv;
			m_uav = uav;
